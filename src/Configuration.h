...
#define XAXIS_STEPS_PER_MM 161  /// 128
#define YAXIS_STEPS_PER_MM 161  //128
#define ZAXIS_STEPS_PER_MM 1600 //8mm leadscrew with 2mm pitch 1/16 microstepping
...
#define EXT0_STEPS_PER_MM 837  //418 original
